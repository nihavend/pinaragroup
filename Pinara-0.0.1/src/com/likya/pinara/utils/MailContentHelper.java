...
public class MailContentHelper {
	...
	public static String getHTMLFormattedJobProperties(HashMap<String, JobImpl> jobQueue, String localizedMessage) {
		...
		if (localizedMessage == null) {
			stringBuilder.append("                    <h1>TLOS Scheduler</h1>" + Pinara.getMessage("JobQueueOperations.64"));
		} else {
		...
		stringBuilder.append("                        </caption>");
		stringBuilder.append("				        <tr>");
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.82"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.84"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.86"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.88"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.90"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.92"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.94"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.96"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.98"));
		stringBuilder.append("				        <th>" + Pinara.getMessage("JobQueueOperations.100"));
		...
		while (jobsIterator.hasNext()) {
			...
			// TODO stringBuilder.append("				        <td>" + extractList(jobProperties.getJobDependencyInfoList()));
		}
	...
	private static StringBuilder pageFooter() {
		...
		footerValue.append("            <br/>Ataşehir, İstanbul, Türkiye");
